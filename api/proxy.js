...
app.get('/api/proxy.js', async (req, res) => {
    ...
    try {
        const response = await axios.get(q, {
            ...
            headers: {
                'User-Agent': ''User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Crome/58.0.3029.110 Safari/537.3', //updated user agent for chrome (thx camouflage)
                'Referer': q,
